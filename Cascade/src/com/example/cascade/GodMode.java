...
//Extremely Hard: Not appropriate for Children :)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		timer = new CountDownTimer((seconds*1000), 1) {
			...
			public void onTick(long millisUntilFinished) {
		         ...
		         //** Start of the Annoying Color Game**
		        ...
		        if(millisUntilFinished / 1000 <= 17 || millisUntilFinished / 1000 <= 25) {
			       
			        centerButton.setVisibility(View.VISIBLE);
		        }
		         
		        if(millisUntilFinished / 1000 <= 14 || millisUntilFinished / 1000 <= 20) {
			       
			        centerButton.setVisibility(View.INVISIBLE);
			        rightButton.setVisibility(View.VISIBLE);
		        }
		        
		        if(millisUntilFinished / 1000 <= 7 || millisUntilFinished / 1000 <= 14) {
			       
			        centerButton.setVisibility(View.INVISIBLE);
			        rightButton.setVisibility(View.VISIBLE);
			        leftButton.setVisibility(View.VISIBLE);
		        }
		        if(millisUntilFinished / 1000 <= 4.5) {
		        ...
		        if(millisUntilFinished / 1000 <= 2.5) {
